window.onload=function () {
    ...
    Q.component("npc", {
        ...
        walkLeft:function () {this.entity.play("walkLeft")},
        walkRight:function () {this.entity.play("walkRight")},
        step:function () {
            var p=this.entity.p;
            p.mark.p.x=p.x;
            if(p.range!=0){
                if(p.ahead=='right'){
                    if(p.x<p.rangeB){p.x +=1;this.entity.trigger("walkRight");}
                    else {p.ahead='left'}
                }else {
                    if(p.x>p.rangeA && p.ahead=='left'){p.x -=1;this.entity.trigger("walkLeft");}
                    else{p.ahead='right'}
                }
            }
            if(p.state==0){p.mark.destroy()}
        }
    });
    Q.component("enemy", {
        added: function() {
        ...
        step:function () {
            ...
            if(this.p.state==3){
                ...
                if(this.p.x<2400){
                    ...
                    this.p.state=4;
                    this.p.rangeA=this.p.x;
                    this.p.rangeB=this.p.x+200;
                    this.p.range=200;
                    this.p.wordA=4;
                    this.p.wordB=5;
                }
    ...
    Q.Sprite.extend("godWatch",{
        ...
        step:function () {
            if(this.p.god1.p.state==0&&this.p.count==0){this.p.god2.p.state=4;this.p.count++};
            if(this.p.god2.p.state==0&&this.p.god1.p.state==0&&this.p.count==1){this.p.god3.p.state=5;this.p.count++};
    ...
    Q.Sprite.extend("dragonWind",{
        ...
        step:function () {
            this.play("Wind");
            if(this.p.ahead=='left'){this.p.x-=1}
            else {this.p.x+=1}
        }
    });
    ...
    Q.animations('vanish',{
        ...
        vanishL:{frames:[14,13,12,11,10,14,13,12,11,10,14,13,12,11,10], rate: 1/8,loop:false,trigger:"stop"}
    });
    Q.animations('dragon',{
    ...
    Q.scene("game",function (stage) {
        ...
        var dave=stage.insert(new Q.Dave());
    ...
    Q.scene("taking",function (stage) {
        ...
        nextBtn.on("click",function () {
            ...
            if(nextBtn.p.label!="好吧"){
                if(i<wordB){
                    switch (i){
                        case 0:words.p.label=villager.p.say1;wordA++;break;
                        case 1:words.p.label=villager.p.say2;wordA++;break;
                        case 2:words.p.label=villager.p.say3;wordA++;break;
                        case 3:words.p.label=villager.p.say4;wordA++;break;
                        case 4:words.p.label=villager.p.say5;wordA++;break;
                        case 5:words.p.label=villager.p.say6;wordA++;break;
                        case 6:words.p.label=villager.p.say7;wordA++;break;
                        case 7:words.p.label=villager.p.say8;wordA++;break;
                        case 8:words.p.label=villager.p.say9;wordA++;break;
                        case 9:words.p.label=villager.p.say10;wordA++;break;
                        case 10:words.p.label=villager.p.say11;wordA++;break;
                    }
                }else {
                    nextBtn.p.label="好吧";
                }
    ...
    Q.scene("dragonSpeak",function (stage) {
        ...
        nextBtn.on("click",function () {
            ...
            if(nextBtn.p.label!="好吧"){
                if(i<wordB){
                    switch (i){
                        case 0:words.p.label=dragon.p.say1;wordA++;break;
                        case 1:words.p.label=dragon.p.say2;wordA++;break;
                        case 2:words.p.label=dragon.p.say3;wordA++;break;
                        case 3:words.p.label=dragon.p.say4;wordA++;break;
                        case 4:words.p.label=dragon.p.say5;wordA++;break;
                        case 5:words.p.label=dragon.p.say6;wordA++;break;
                        case 6:words.p.label=dragon.p.say7;wordA++;break;
                        case 7:words.p.label=dragon.p.say8;wordA++;break;
                        case 8:words.p.label=dragon.p.say9;wordA++;break;
                        case 9:words.p.label=dragon.p.say10;wordA++;break;
                    }
                }else {
                    nextBtn.p.label="好吧";
                }
    ...
    Q.scene("godSecret",function (stage) {
        ...
        stage.insert(new Q.backgroud('',1800));
    ...
    Q.scene("test",function (stage) {
        var player=stage.insert(new Q.player());
        player.p.weapon=new Q.weaponVanish();
        player.p.equipment=1;
        //player.p.weapon.p.type= Q.SPRITE_DEFAULT;
        var dragon=stage.insert(new Q.dragon('',900));
    });


    //加载背景
    Q.preload(["background.png","background-floor.png"]);
    //加载建筑
