window.onload=function () {
    ...
    Q.Sprite.extend("hula",{
        ...
        step:function () {
            ...
            if(Q("player",0).first().p.blood==0){
                if(Q("dragon",0).first().p.state==2){
                    Q.clearStages();
    ...
    Q.scene("dragonSpeak",function (stage) {
        ...
        var wordA=dragon.p.wordA;
        var wordB=dragon.p.wordB;
        nextBtn.on("click",function () {
            var i=wordA;
            if(nextBtn.p.label!="好吧"){
                if(i<wordB){
    ...
    Q.scene("godSecret",function (stage) {
        ...
        var dragon=stage.insert(new Q.dragon('',2000));
    ...
    //加载杂物
    Q.preload(["dagger.png","weapon.json"]);
